...
namespace HeroesOpTool.RCUser.ServerMonitorSystem
{
	public class ServerMonitorControl : UserControl
	{
		...
		public ServerMonitorControl(RCUserHandler rcUser)
		{
			...
			this.LogGenerator = new LogGenerator("Full log", "Full log");
		...
		private void InitializeComponent()
		{
			...
			this.GroupClientList.Text = "List of programs belonging to the workgroup and individual status";
			this.ToolTipServerControl.SetToolTip(this.GroupClientList, "Select the programs you want to control.");
			...
			this.ToolTipServerControl.SetToolTip(this.LViewClientList, "Select the programs you want to control.");
			...
			this.ColumnProcessName.Text = "Program name";
			this.ColumnProcessName.Width = 180;
			this.ColumnClientName.Text = "Computer name";
			this.ColumnClientName.Width = 180;
			this.ColumnProcessState.Text = "state";
			this.ColumnPerformance.Text = "Performance";
			this.ColumnPerformance.Width = 120;
			this.ColumnServerIP.Text = "Сomputer IP";
			...
			this.TSMISplitLog.Text = "View logs in a new window";
			...
			this.TSMIChildProcess.Text = "Child process log";
			...
			this.TSMIExeInfo.Text = "Viewing executable file information";
			...
			this.tabPageWorkGroup.Text = "Work group";
			...
			this.menuItemSelectOnly.Text = "Select only this item (Ctrl + Click)";
			...
			this.menuItemSelectSameName.Text = "Select all the same names as this item (Shift + Click)";
			...
			this.menuItemDeselectAll.Text = "All off";
			...
			this.menuItemSort.Text = "Sort list in tree structure";
			...
			this.tabPageServerGroup.Text = "Server group";
			...
			this.TabPageLogGeneral.Text = "Full log";
			...
			this.ToolTipServerControl.SetToolTip(this.TBoxLogGeneral, "It shows a general log of the overall situation.");
			...
			this.TSBGeneralLog.Text = "View in new window";
			...
			this.TabPageLogProcess.Text = "The output log of the program";
			...
			this.TSBProcessLog.Text = "View in new window";
			this.TSBProcessLog.ToolTipText = "Bring up a new window to view the log";
			...
			this.TSBAllProcessLog.Text = "View all process logs";
			this.TSBAllProcessLog.ToolTipText = "Bring up a new window to view all process logs.";
			...
			this.TStrpBtnSvrCommand.Text = "Server work";
			...
			this.TStrpBtnCommand.Text = "Program work";
			...
			this.TStrpBtnSync.Text = "Patch check";
