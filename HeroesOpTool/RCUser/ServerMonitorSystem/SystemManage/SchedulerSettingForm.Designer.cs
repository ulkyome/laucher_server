namespace HeroesOpTool.RCUser.ServerMonitorSystem.SystemManage
{
	public partial class SchedulerSettingForm : global::System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBoxSchedule.Text = "Action plan";
			...
			this.labelScheduleTime.Text = "date";
			...
			this.labelScheduleType.Text = "When to run";
			...
			this.checkBoxDisabled.Text = "Not used";
