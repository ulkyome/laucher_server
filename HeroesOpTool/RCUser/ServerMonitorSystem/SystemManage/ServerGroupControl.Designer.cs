...
namespace HeroesOpTool.RCUser.ServerMonitorSystem.SystemManage
{
	public class ServerGroupControl : UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolTipServerGroupControl.SetToolTip(this.treeViewServerGroup, "It shows the structure of the current server group.\nClick the right mouse button to select the desired task.");
			...
			this.toolTipServerGroupControl.SetToolTip(this.listViewBound, "This is a list of programs belonging to the currently selected server group.");
			...
			this.labelServerGroup.Text = "Server group structure";
			...
			this.labelBound.Text = "List of clients connected to the server group";
			...
			this.toolTipServerGroupControl.SetToolTip(this.listViewUnbound, "This is a list of the programs of the currently connected remote control server that do not belong to any work group. You can drag it into a workgroup.");
			...
			this.labelUnbound.Text = "List of clients not connected to anywhere";
