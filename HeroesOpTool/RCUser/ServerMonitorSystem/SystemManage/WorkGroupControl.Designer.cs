...
namespace HeroesOpTool.RCUser.ServerMonitorSystem.SystemManage
{
	public class WorkGroupControl : UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolTipWorkGroupControl.SetToolTip(this.treeViewWorkGroup, "Shows the structure of the current workgroup.\nClick the right mouse button to select the desired task.");
			...
			this.menuItemWorkGroupRename.Text = "Change the workgroup name";
			...
			this.menuItemWorkGroupNew.Text = "Add child workgroup";
			...
			this.menuItemWorkGroupDelete.Text = "Delete workgroup";
			...
			this.menuItemWorkGroupMoveUp.Text = "Move up workgroup";
			...
			this.menuItemWorkGroupMoveDown.Text = "Move down workgroup";
			...
			this.menuItemWorkGroupNewRoot.Text = "Add new root workgroup";
			...
			this.toolTipWorkGroupControl.SetToolTip(this.listViewBound, "It is a list of programs belonging to the currently selected work group.");
			...
			this.menuItemClientProcessAdd.Text = "Add new program";
			...
			this.menuItemClientProcessRemove.Text = "Delete linked program";
			...
			this.labelWorkGroup.Text = "The structure of the work group";
			...
			this.labelClientProcess.Text = "List of programs connected to the workgroup";
			...
			this.toolTipWorkGroupControl.SetToolTip(this.listViewUnbound, "This is a list of the programs of the currently connected remote control server that do not belong to any work group. You can drag it into a workgroup.");
			...
			this.columnHeader4.Text = "Program name";
			...
			this.labelUnboundProcess.Text = "List of programs not linked to anywhere";
